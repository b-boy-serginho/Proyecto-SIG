...
import 'package:mapas_api/models/places_models.dart';

import 'package:mapas_api/models/route_destination.dart';

import 'package:mapas_api/services/services.dart';
...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  ...
  Future<RouteDestination> getCoorsStartToEnd(LatLng start, LatLng end) async {
    ...
    // Imprimir puntos decodificados

    print('Puntos decodificados: $latLngList');
